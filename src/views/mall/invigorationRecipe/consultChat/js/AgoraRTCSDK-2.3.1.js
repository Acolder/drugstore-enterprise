var AgoraRTC = function(e, t) {
        ...
        , r = function() {
          ...
          t = function() {
              ...
              if (!(e < s))
                  ...
                  case 0:
                      t[0] = (0,
                      i.getTimestamp)() + " Agora-SDK [DEBUG]:",
                      console.log.apply(console, t);
                      break;
                  case 1:
                      t[0] = (0,
                      i.getTimestamp)() + " Agora-SDK [INFO]:",
                      console.log.apply(console, t);
                      break;
                  case 2:
                      t[0] = (0,
                      i.getTimestamp)() + " Agora-SDK [WARN]:",
                      console.warn.apply(console, t);
                      break;
                  case 3:
                      t[0] = (0,
                      i.getTimestamp)() + " Agora-SDK [ERROR]:",
                      console.error.apply(console, t);
                      break;
                  default:
                      return t[0] = (0,
                      i.getTimestamp)() + " Agora-SDK [DEFAULT]:",
          ...
          ,
          o = function() {
              for (var e = [2], n = 0; n < arguments.length; n++)
                  e.push(arguments[n]);
              t.apply(this, e)
          }
          ,
          a = function() {
              for (var e = [3], n = 0; n < arguments.length; n++)
                  e.push(arguments[n]);
              t.apply(this, e)
          }
          ,
      ...
      var i = function() {
          ...
          e.dispatchEvent = function(t) {
              ...
              for (n in e.dispatcher.eventListeners[t.type])
                  e.dispatcher.eventListeners[t.type].hasOwnProperty(n) && "function" == typeof e.dispatcher.eventListeners[t.type][n] && e.dispatcher.eventListeners[t.type][n](t)
          }
          ,
          e.dispatchSocketEvent = function(t) {
              var n;
              for (n in e.dispatcher.eventListeners[t.type])
                  e.dispatcher.eventListeners[t.type].hasOwnProperty(n) && "function" == typeof e.dispatcher.eventListeners[t.type][n] && e.dispatcher.eventListeners[t.type][n](t.msg)
          }
          ,
          e
      }
  ...
  , function(e, t, n) {
      ...
      if ("object" === ("undefined" == typeof window ? "undefined" : r(window)) && (!window.HTMLMediaElement || "srcObject"in window.HTMLMediaElement.prototype || Object.defineProperty(window.HTMLMediaElement.prototype, "srcObject", {
          ...
          set: function(e) {
              "mozSrcObject"in this ? this.mozSrcObject = e : (this._srcObject = e,
      ...
      "undefined" != typeof window && window.navigator)
          if (navigator.mozGetUserMedia && window.mozRTCPeerConnection) {
              if (p.log("This appears to be Firefox"),
              d = "firefox",
                      ...
                      for (var n = [], i = 0; i < e.iceServers.length; i++) {
                          ...
                          if (r.hasOwnProperty("urls"))
                              for (var o = 0; o < r.urls.length; o++) {
                                  ...
                                  0 === r.urls[o].indexOf("turn") && (a.username = r.username,
                                  a.credential = r.credential),
                                  n.push(a)
                              }
                          else
              ...
              o = function(e, t, n) {
                  var i = function(e) {
                      if ("object" !== (void 0 === e ? "undefined" : r(e)) || e.require)
                          return e;
                      var t = [];
                  ...
                  return c < 38 && (p.log("spec: " + JSON.stringify(e)),
                  e.audio && (e.audio = i(e.audio)),
                  e.video && (e.video = i(e.video)),
                  p.log("ff37: " + JSON.stringify(e))),
              ...
              var m = function(e) {
                  if ("object" !== (void 0 === e ? "undefined" : r(e)) || e.mandatory || e.optional)
                      return e;
                  var t = {};
                  return Object.keys(e).forEach(function(n) {
                      if ("require" !== n && "advanced" !== n && "mediaSource" !== n) {
                          ...
                          if (void 0 !== i.ideal) {
                              ...
                              var a = {};
                              "number" == typeof i.ideal ? (a[o("min", n)] = i.ideal,
                              t.optional.push(a),
                              a = {},
                              a[o("max", n)] = i.ideal,
                              t.optional.push(a)) : (a[o("", n)] = i.ideal,
                              t.optional.push(a))
                          }
                          void 0 !== i.exact && "number" != typeof i.exact ? (t.mandatory = t.mandatory || {},
                          t.mandatory[o("", n)] = i.exact) : ["min", "max"].forEach(function(e) {
              ...
              if (o = function(e, t, n) {
                  return e.audio && (e.audio = m(e.audio)),
                  e.video && (e.video = m(e.video)),
                  p.log("chrome: " + JSON.stringify(e)),
              ...
              navigator.mediaDevices.getUserMedia) {
                  ...
                  navigator.mediaDevices.getUserMedia = function(e) {
                      return p.log("spec:   " + JSON.stringify(e)),
                      e.audio = m(e.audio),
                      e.video = m(e.video),
                      p.log("chrome: " + JSON.stringify(e)),
                      g(e)
              ...
              navigator.mediaDevices && navigator.userAgent.match(/Edge\/(\d+).(\d+)$/) ? (p.log("This appears to be Edge"),
              d = "edge",
              c = p.extractVersion(navigator.userAgent, /Edge\/(\d+).(\d+)$/, 2),
              u = 12) : p.log("Browser does not appear to be WebRTC-capable");
      else
          p.log("This does not appear to be a browser"),
          d = "not a browser";
      var v = {};
      try {
      ...
      var _;
      l ? _ = l : "undefined" != typeof window && (_ = window.RTCPeerConnection),
      e.exports = {
          RTCPeerConnection: _,
          getUserMedia: o,
          attachMediaStream: a,
  ...
  , function(e, t, n) {
      ...
      var i = n(1)
        ...
        , c = function() {
          ...
          return e.list = {},
          e.url = (0,
          s.shouldUseHttps)() ? "https://" + r.EVENT_REPORT_DOMAIN + ":6443/events/report" : "http://" + r.EVENT_REPORT_DOMAIN + ":6080/events/report",
          e.urlBackup = (0,
          s.shouldUseHttps)() ? "https://" + r.EVENT_REPORT_BACKUP_DOMAIN + ":6443/events/report" : "http://" + r.EVENT_REPORT_BACKUP_DOMAIN + ":6080/events/report",
          e.setProxyServer = function(t) {
              t && (e.url = (0,
              s.shouldUseHttps)() ? "https://" + t + "/rs/?h=" + r.EVENT_REPORT_DOMAIN + "&p=6443&d=events/report" : "http://" + t + "/rs/?h=" + r.EVENT_REPORT_DOMAIN + "&p=6080&d=events/report",
              e.urlBackup = (0,
              s.shouldUseHttps)() ? "https://" + t + "/rs/?h=" + r.EVENT_REPORT_BACKUP_DOMAIN + "&p=6443&d=events/report" : "http://" + t + "/rs/?h=" + r.EVENT_REPORT_BACKUP_DOMAIN + "&p=6080&d=events/report",
          ...
          e.joinChooseServer = function(t, n, i) {
              var r;
              r = i ? Object.assign(e.list[t], n) : Object.assign({}, e.list[t], n),
          ...
          e.firstRemoteFrame = function(t, n) {
              var i = Object.assign({}, e.list[t], n);
              i.type = "first_remote_frame",
              i.lts = +new Date,
              i.elaps = i.lts - i.startTime,
              e.send(i)
          }
          ,
          e.streamSwitch = function(t, n) {
              var i = Object.assign({}, e.list[t], n);
              i.type = "stream_switch",
              i.isdual = n.isdual,
              i.lts = +new Date,
              i.elaps = i.lts - i.startTime,
              e.send(i)
          ...
          e.send = function(t) {
              try {
                  (0,
                  s.post)(e.url, t, null, function(n) {
                      (0,
                      s.post)(e.urlBackup, t, null, function(e) {}, {
                          timeout: 1e4
                      })
                  }, {
                      timeout: 1e4
  ...
  , function(e, t, n) {
      ...
      function r() {
          return (0,
          l.default)().replace(/-/g, "").toUpperCase()
      }
      Object.defineProperty(t, "__esModule", {
          value: !0
      }),
      ...
      : function(e) {
        ...
        , p = function() {
          var e = window.RTCPeerConnection || window.mozRTCPeerConnection || window.webkitRTCPeerConnection
            ...
            , i = !!e && !!t && !!n
            , r = !1;
          return c.default.debug(s.getBrowserInfo(), "isAPISupport:" + i),
        ...
        , v = function(e) {
          if (g)
              ...
              this.getAudioLevel = function() {
                  ...
                  return c.default.warning("can't find analyser in audioLevelHelper"),
                  0
              }
              ,
              this
        ...
        , _ = function(e, t, n) {
          try {
              ...
              i.addEventListener("playing", function(e) {
                  s.isFireFox() ? i.videoWidth && (t(i.videoWidth, i.videoHeight),
                  document.body.removeChild(i)) : (t(i.videoWidth, i.videoHeight),
        ...
        , E = function(e) {
          ...
          for (var n in e)
              if ("lowLatency" === n && "boolean" != typeof e[n] || "userConfigExtraInfo" === n && "object" !== o(e[n]) || "transcodingUsers" === n && !h(e[n]) || !~t.indexOf(n) && "number" != typeof e[n])
          ...
          for (var t = 0; t < e.length; t++)
              for (var n in e[t])
                  if ("number" != typeof e[t][n])
                      throw new Error("Param user[" + t + "] - [" + n + "] is inVaild");
          return !0
      }
        , I = function(e) {
          isNaN(e) && (e = 1e3);
  ...
  , function(e, t, n) {
      ...
      t.default = i,
      t.GatewayErrorCode = r,
      t.JOIN_GS_TRYNEXT_LIST = o,
      t.JOIN_CS_RETRY_LIST = a
  }
  , function(e, t, n) {
      "use strict";
      function i(e) {
      ...
      : function(e) {
        ...
        , g = function(e) {
          ...
          i.mirror = !1 !== e.mirror,
          !(void 0 === i.videoSize || i.videoSize instanceof Array && 4 === i.videoSize.length))
              throw Error("Invalid Video Size");
          i.videoSize = [640, 480, 640, 480],
          void 0 !== e.local && !0 !== e.local || (i.local = !0),
          i.initialized = !i.local;
          var o = {
              true: !0,
              unspecified: !0,
              "90p_1": n(160, 90),
          ...
          i.setVideoFrameRate = function(t) {
              return !(0,
              l.isFireFox)() && ("object" === (void 0 === t ? "undefined" : r(t)) && t instanceof Array && t.length > 1 && (e.attributes = e.attributes || {},
          ...
          i.setScreenProfile = function(e) {
              if ("string" == typeof e && i.screen) {
                  switch (e) {
                  case "480p_1":
                      i.screenAttributes.width = 640,
                      i.screenAttributes.height = 480,
                      i.screenAttributes.maxFr = 5,
                      i.screenAttributes.minFr = 1;
                      break;
                  case "480p_2":
                      i.screenAttributes.width = 640,
                      i.screenAttributes.height = 480,
                      i.screenAttributes.maxFr = 30,
                      i.screenAttributes.minFr = 25;
                      break;
                  case "720p_1":
                      i.screenAttributes.width = 1280,
                      i.screenAttributes.height = 720,
                      i.screenAttributes.maxFr = 5,
                      i.screenAttributes.minFr = 1;
                      break;
                  case "720p_2":
                      ...
                      break;
                  case "1080p_1":
                      i.screenAttributes.width = 1920,
                      i.screenAttributes.height = 1080,
                      i.screenAttributes.maxFr = 5,
                      i.screenAttributes.minFr = 1;
                      break;
                  case "1080p_2":
          ...
          i.setVideoProfileCustom = function(e) {
              i.setVideoResolution(e[0]),
              i.setVideoFrameRate([e[1], e[1]]),
              i.setVideoBitRate([e[2], e[2]])
          }
          ,
          ...
          i.setVideoProfile = function(e) {
              if (i.profile = e,
              "string" == typeof e && i.video) {
                  switch (e) {
                  case "120p":
                  case "120P":
                  case "120p_1":
                  case "120P_1":
                      i.setVideoResolution("120p_1"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([10, 65]);
                      break;
                  case "120p_3":
                  case "120P_3":
                      i.setVideoResolution("120p_3"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([10, 50]);
                      break;
                  case "180p":
                  case "180P":
                  case "180p_1":
                  case "180P_1":
                      i.setVideoResolution("180p_1"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([10, 140]);
                      break;
                  case "180p_3":
                  case "180P_3":
                      i.setVideoResolution("180p_3"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([10, 100]);
                      break;
                  case "180p_4":
                  case "180P_4":
                      i.setVideoResolution("180p_4"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([10, 120]);
                      break;
                  case "240p":
                  case "240P":
                  case "240p_1":
                  case "240P_1":
                      i.setVideoResolution("240p_1"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([10, 200]);
                      break;
                  case "240p_3":
                  case "240P_3":
                      i.setVideoResolution("240p_3"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([10, 140]);
                      break;
                  case "240p_4":
                  case "240P_4":
                      i.setVideoResolution("240p_4"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([10, 220]);
                      break;
                  case "360p":
                  case "360P":
                  case "360p_1":
                  case "360P_1":
                      i.setVideoResolution("360p_1"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([20, 400]);
                      break;
                  case "360p_3":
                  case "360P_3":
                      i.setVideoResolution("360p_3"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([20, 260]);
                      break;
                  case "360p_4":
                  case "360P_4":
                      i.setVideoResolution("360p_4"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([20, 600]);
                      break;
                  case "360p_6":
                  case "360P_6":
                      i.setVideoResolution("360p_6"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([20, 400]);
                      break;
                  case "360p_7":
                  case "360P_7":
                      i.setVideoResolution("360p_7"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([20, 320]);
                      break;
                  case "360p_8":
                  case "360P_8":
                      i.setVideoResolution("360p_8"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([20, 490]);
                      break;
                  case "360p_9":
                  case "360P_9":
                      i.setVideoResolution("360p_9"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([20, 800]);
                      break;
                  case "360p_10":
                  case "360P_10":
                      i.setVideoResolution("360p_10"),
                      i.setVideoFrameRate([24, 24]),
                      i.setVideoBitRate([20, 800]);
                      break;
                  case "360p_11":
                  case "360P_11":
                      i.setVideoResolution("360p_11"),
                      i.setVideoFrameRate([24, 24]),
                      i.setVideoBitRate([20, 1e3]);
                      break;
                  case "480p":
                  case "480P":
                  case "480p_1":
                  case "480P_1":
                      i.setVideoResolution("480p_1"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([20, 500]);
                      break;
                  case "480p_2":
                  case "480P_2":
                      i.setVideoResolution("480p_2"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([20, 1e3]);
                      break;
                  case "480p_3":
                  case "480P_3":
                      i.setVideoResolution("480p_3"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([20, 400]);
                      break;
                  case "480p_4":
                  case "480P_4":
                      i.setVideoResolution("480p_4"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([20, 750]);
                      break;
                  case "480p_6":
                  case "480P_6":
                      i.setVideoResolution("480p_6"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([20, 600]);
                      break;
                  case "480p_8":
                  case "480P_8":
                      i.setVideoResolution("480p_8"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([20, 610]);
                      break;
                  case "480p_9":
                  case "480P_9":
                      i.setVideoResolution("480p_9"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([20, 930]);
                      break;
                  case "480p_10":
                  case "480P_10":
                      i.setVideoResolution("480p_10"),
                      i.setVideoFrameRate([10, 10]),
                      i.setVideoBitRate([20, 400]);
                      break;
                  case "720p":
                  case "720P":
                  case "720p_1":
                  case "720P_1":
                      i.setVideoResolution("720p_1"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([30, 1130]);
                      break;
                  case "720p_2":
                  case "720P_2":
                      i.setVideoResolution("720p_2"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([30, 2e3]);
                      break;
                  case "720p_3":
                  case "720P_3":
                      i.setVideoResolution("720p_3"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([30, 1710]);
                      break;
                  case "720p_5":
                  case "720P_5":
                      i.setVideoResolution("720p_5"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([30, 910]);
                      break;
                  case "720p_6":
                  case "720P_6":
                      i.setVideoResolution("720p_6"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([30, 1380]);
                      break;
                  case "1080p":
                  case "1080P":
                  case "1080p_1":
                  case "1080P_1":
                      i.setVideoResolution("1080p_1"),
                      i.setVideoFrameRate([15, 15]),
                      i.setVideoBitRate([50, 2080]);
                      break;
                  case "1080p_2":
                  case "1080P_2":
                      i.setVideoResolution("1080p_2"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([50, 3e3]);
                      break;
                  case "1080p_3":
                  case "1080P_3":
                      i.setVideoResolution("1080p_3"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([50, 3150]);
                      break;
                  case "1080p_5":
                  case "1080P_5":
                      i.setVideoResolution("1080p_5"),
                      i.setVideoFrameRate([60, 60]),
                      i.setVideoBitRate([50, 4780]);
                      break;
                  case "1440p":
                  case "1440P":
                  case "1440p_1":
                  case "1440P_1":
                      i.setVideoResolution("1440p_1"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([50, 4850]);
                      break;
                  case "1440p_2":
                  case "1440P_2":
                      i.setVideoResolution("1440p_2"),
                      i.setVideoFrameRate([60, 60]),
                      i.setVideoBitRate([50, 7350]);
                      break;
                  case "4k":
                  case "4K":
                  case "4k_1":
                  case "4K_1":
                      i.setVideoResolution("4k_1"),
                      i.setVideoFrameRate([30, 30]),
                      i.setVideoBitRate([50, 8910]);
                      break;
                  case "4k_3":
                  case "4K_3":
                      i.setVideoResolution("4k_3"),
                      i.setVideoFrameRate([60, 60]),
                      i.setVideoBitRate([50, 13500]);
                      break;
                  default:
                      i.setVideoResolution("480p_1"),
                      i.setVideoFrameRate([15, 15]),
          ...
          i.init = function(n, o) {
              ...
              if (void 0 === a && (a = 2),
              !0 === i.initialized)
                  return void ("function" == typeof o && o({
                      type: "warning",
                  ...
                  if ((e.audio || e.video || e.screen) && void 0 === e.url) {
                      ...
                      if (e.screen)
                          ...
                          if (!t()) {
                              var p = 30
                                , m = 30;
                              if (void 0 !== e.attributes.minFrameRate && (p = e.attributes.minFrameRate),
                              void 0 !== e.attributes.maxFrameRate && (m = e.attributes.maxFrameRate),
                              !0 === c.audio && (c.audio = !e.microphoneId || {
                                  deviceId: {
                              ...
                              i.audioProcessing)) {
                                  var g = {};
                                  void 0 !== i.audioProcessing.AGC && ((0,
                                  l.isFireFox)() ? g.autoGainControl = i.audioProcessing.AGC : (0,
                                  l.isChrome)() && (g.googAutoGainControl = i.audioProcessing.AGC,
                                  g.googAutoGainControl2 = i.audioProcessing.AGC)),
                                  0 !== Object.keys(g).length && (!0 === c.audio ? c.audio = {
                                      mandatory: g
                      ...
                      if ((0,
                      s.GetUserMedia)(v, function(t) {
                          var r = t.getVideoTracks().length > 0
                            , a = t.getAudioTracks().length > 0;
                          return v.video && !r && v.audio && !a ? (u.default.error("Media access: NO_CAMERA_MIC_PERMISSION"),
                          o && o("NO_CAMERA_MIC_PERMISSION")) : v.video && !r ? (u.default.error("Media access: NO_CAMERA_PERMISSION"),
                          o && o("NO_CAMERA_PERMISSION")) : v.screen && !r ? (u.default.error("Media access: NO_SCREEN_PERMISSION"),
                          o && o("NO_SCREEN_PERMISSION")) : v.audio && !a ? (u.default.error("Media access: NO_MIC_PERMISSION"),
                          o && o("NO_MIC_PERMISSION")) : (u.default.debug("User has granted access to local media"),
                          i.dispatchEvent({
                              type: "accessAllowed"
                          }),
                          i.stream = t,
                          ...
                          void (e.screen && (0,
                          l.isChrome)() && i.stream && i.stream.getVideoTracks()[0] && (i.stream.getVideoTracks()[0].onended = function() {
                              i.dispatchEvent({
                          ...
                          u.default.error("Media access:", t.msg),
          ...
          ,
          i.close = function() {
              if (u.default.debug("Close stream with id", i.streamId),
              void 0 !== i.stream) {
              ...
              i.unmuteVideo = void 0,
              i.muteVideo = void 0,
              i.lowStream && i.lowStream.close()
          }
          ,
          i.enableAudio = function() {
              return u.default.debug("Enable audio stream with id", i.streamId),
              !(!i.hasAudio() || !i.initialized || void 0 === i.stream || !0 === i.stream.getAudioTracks()[0].enabled) && (void 0 !== i.unmuteAudio && i.unmuteAudio(),
              i.audioEnabled = !0,
              i.stream.getAudioTracks()[0].enabled = !0,
              !0)
          }
          ,
          i.disableAudio = function() {
              return u.default.debug("Disable audio stream with id", i.streamId),
              !!(i.hasAudio() && i.initialized && void 0 !== i.stream && i.stream.getAudioTracks()[0].enabled) && (void 0 !== i.muteAudio && i.muteAudio(),
              i.audioEnabled = !1,
              i.stream.getAudioTracks()[0].enabled = !1,
              i.sid && m.report.audioSendingStopped(i.sid, {
                  succ: !0,
                  reason: "muteAudio"
              }),
              !0)
          ...
          i.enableVideo = function() {
              return u.default.debug("Enable video stream with id", i.streamId),
              !(!i.initialized || void 0 === i.stream || !i.stream.getVideoTracks().length || !0 === i.stream.getVideoTracks()[0].enabled) && (void 0 !== i.unmuteVideo && i.unmuteVideo(),
              i.videoEnabled = !0,
              i.stream.getVideoTracks()[0].enabled = !0,
              i.lowStream && i.lowStream.enableVideo(),
              !0)
          }
          ,
          i.disableVideo = function() {
              return u.default.debug("Disable video stream with id", i.streamId),
              !!(i.initialized && void 0 !== i.stream && i.stream.getVideoTracks().length && i.stream.getVideoTracks()[0].enabled) && (void 0 !== i.muteVideo && i.muteVideo(),
              i.videoEnabled = !1,
              i.stream.getVideoTracks()[0].enabled = !1,
              i.lowStream && i.lowStream.disableVideo(),
              i.sid && m.report.videoSendingStopped(i.sid, {
                  succ: !0,
                  reason: "muteVideo"
              }),
              !0)
          ...
          i.play = function(e, t) {
              i.showing = !1,
              !i.local || i.video || i.screen ? void 0 !== e && (i.player = new a.default({
                  id: i.getId(),
                  stream: i,
                  elementID: e,
                  options: void 0,
              ...
              i.showing = !0) : i.hasAudio() && (i.player = new a.default({
                  id: i.getId(),
                  stream: i,
                  elementID: e,
                  options: void 0,
          ...
          ,
          i.stop = function() {
              u.default.debug("Stop stream player with id", i.streamId),
              void 0 !== i.player && i.player.destroy()
          }
          ,
          i.getStats = function(e) {
              i.pc && i.pc.getStats ? i.pc.getStats(function(t) {
                  if (i.pc.isSubscriber) {
                      var n = (0,
                      p.subscribeStatsFilter)(t);
                      (0,
                      l.isFireFox)() && (n.videoReceivedResolutionHeight = i.videoHeight + "",
                      n.videoReceivedResolutionWidth = i.videoWidth + ""),
                      e && e((0,
                      p.subscribeStatsFilter)(t))
                  } else {
                      var n = (0,
                      p.publishStatsFilter)(t);
                      ((0,
                      l.isSafari)() || (0,
                      l.isFireFox)()) && (n.videoSendResolutionHeight = i.videoHeight + "",
                      n.videoSendResolutionWidth = i.videoWidth + ""),
                      ((0,
                      l.isSafari)() || (0,
                      l.isFireFox)()) && i.uplinkStats && (n.videoSendBandwidth = i.uplinkStats.uplink_available_bandwidth + "",
                      n.videoSendPacketsLost = i.uplinkStats.uplink_cumulative_lost + ""),
                      e && e(n)
                  }
          ...
          i.getAudioLevel = function() {
              return i.audioLevelHelper ? i.audioLevelHelper.getAudioLevel() : i.stream ? 0 !== i.stream.getAudioTracks().length ? (i.audioLevelHelper = new f.audioLevelHelper(i.stream),
              i.audioLevelHelper.getAudioLevel()) : void u.default.warning("can't get audioLevel beacuse no audio trace in stream") : (u.default.warning("can't get audioLevel beacuse no stream exist"),
              0)
          }
          ,
          i
        ...
        , v = function(e) {
          return u.default.debug("Create stream"),
          g(e)
      }
        , _ = function(e, t) {
      ...
      var r = n(23)
        ...
        , I = function(e, t, n) {
          ...
          e.screen) {
              ...
              if (i)
                  return void (i.desktopCapturer ? new _.default(e,t,n).shareScreen(i) : n(S.ErrorCodes.ELECTRON_NOT_SUPPORT_SHARING_SCREEN));
              if (g.default.debug("Screen access requested"),
              null !== window.navigator.userAgent.match("Firefox")) {
                  ...
                  var r = {};
                  void 0 != e.video.mandatory ? (r.video = e.video,
                  r.video.mediaSource = e.mediaSource) : r = {
                      video: {
                          mediaSource: e.mediaSource
                      }
                  },
                  ...
                  e.extensionId && (g.default.debug("extensionId supplied, using " + e.extensionId),
                  o = e.extensionId),
                  ...
                  try {
                      chrome.runtime.sendMessage(o, {
                          ...
                          if (void 0 === i)
                              return g.default.debug("Access to screen denied"),
                              void n({
              ...
              window.navigator.userAgent.indexOf("Safari") > -1 && -1 === navigator.userAgent.indexOf("Chrome") ? navigator.mediaDevices.getUserMedia(e).then(t).catch(n) : "undefined" != typeof navigator && navigator.getMedia ? navigator.getMedia(e, t, n) : g.default.error("Video/audio streams not supported yet")
      };
      t.Connection = h,
      t.GetUserMedia = I
  }
  ...
  , function(e, t, n) {
      ...
      function(e, t, n, i) {
        ...
        , p = function(e, t, n) {
          for (var i = (new Date).getTime(), r = !1, a = !0, p = function(n, o) {
              if (r)
                  c.report.joinChooseServer(e.sid, {
                      lts: i,
                      succ: !0,
                      csAddr: o,
              ...
              a && (s.default.error(e, t, i),
              i && !u.JOIN_CS_RETRY_LIST.includes(i) && (a = !1,
              n(i)))
          }, m = o.WEBCS_DOMAIN, g = 0; g < m.length; ++g) {
              var v;
              v = e.proxyServer ? (0,
              d.shouldUseHttps)() ? "https://" + e.proxyServer + "/cs/?h=" + m[g] + "&p=5668&d=getwebgw/jsonp" : "http://" + e.proxyServer + "/cs/?h=" + m[g] + "&p=5669&d=getwebgw/jsonp" : (0,
              d.shouldUseHttps)() ? "https://" + m[g] + ":5668/getwebgw/jsonp" : "http://" + m[g] + ":5669/getwebgw/jsonp",
          ...
          var _ = setTimeout(function() {
              if (!r)
                  for (var t = o.WEBCS_DOMAIN_BACKUP_LIST, n = 0; n < t.length; ++n) {
                      var i;
                      i = e.proxyServer ? (0,
                      d.shouldUseHttps)() ? "https://" + e.proxyServer + "/cs/?h=" + t[n] + "&p=5668&d=getwebgw/jsonp" : "http://" + e.proxyServer + "/cs/?h=" + t[n] + "&p=5669&d=getwebgw/jsonp" : (0,
                      d.shouldUseHttps)() ? "https://" + t[n] + ":5668/getwebgw/jsonp" : "http://" + t[n] + ":5669/getwebgw/jsonp",
        ...
        , f = function(e, t, n) {
          ...
          !function n() {
              i || p(e, function(e) {
                  ...
                  if (e)
                      return void s.default.info("Join failed: " + e);
      ...
      var r = n(21)
        ...
        , l = function(e) {
          ...
          t.resize = function() {
              ...
              e.stream.screen ? .75 * n < i ? (t.video.style.width = n + "px",
              t.video.style.height = .75 * n + "px",
              t.video.style.top = -(.75 * n / 2 - i / 2) + "px",
              t.video.style.left = "0px") : (t.video.style.height = i + "px",
              t.video.style.width = 4 / 3 * i + "px",
              t.video.style.left = -(4 / 3 * i / 2 - n / 2) + "px",
              t.video.style.top = "0px") : n === t.containerWidth && i === t.containerHeight || (.75 * n > i ? (t.video.style.width = n + "px",
              t.video.style.height = .75 * n + "px",
              t.video.style.top = -(.75 * n / 2 - i / 2) + "px",
              t.video.style.left = "0px") : (t.video.style.height = i + "px",
              t.video.style.width = 4 / 3 * i + "px",
          ...
          e.stream.local && !e.stream.screen ? e.stream.mirror ? t.video.setAttribute("style", "width: 100%; height: 100%; position: absolute; transform: rotateY(180deg);") : t.video.setAttribute("style", "width: 100%; height: 100%; position: absolute; ") : e.stream.video ? (t.video.setAttribute("style", "width: 100%; height: 100%; position: absolute;"),
          window.navigator.userAgent.indexOf("Safari") > -1 && -1 === navigator.userAgent.indexOf("Chrome") && t.video.setAttribute("controls", "")) : e.stream.screen ? t.video.setAttribute("style", "width: 100%; height: 100%; position: absolute;") : t.video.setAttribute("style", "width: 100%; height: 100%; position: absolute; display: none;"),
          t.video.setAttribute("autoplay", ""),
          t.video.setAttribute("muted", ""),
          t.video.setAttribute("playsinline", ""),
          e.stream.local && (t.video.volume = 0,
          t.video.setAttribute("muted", "")),
          t.audio = document.createElement("audio"),
          t.audio.setAttribute("id", "audio" + t.id),
          t.audio.setAttribute("autoplay", ""),
          e.stream.local && (t.audio.volume = 0,
          t.audio.setAttribute("muted", "")),
          ...
          t.video.addEventListener("playing", function(e) {
              !function e() {
                  if (t.video.videoWidth * t.video.videoHeight > 4)
                      return void c.default.debug("video dimensions:", t.video.videoWidth, t.video.videoHeight);
                  setTimeout(e, 50)
              }()
          }),
          t.containerWidth = 0,
          ...
          e.stream.hasVideo() || e.stream.hasScreen())
              ...
              (0,
              u.attachMediaStream)(t.video, e.stream.stream),
              (0,
              u.attachMediaStream)(t.audio, e.stream.stream);
          else if (!e.stream.local && t.video.removeAttribute("muted"),
          t.div.appendChild(t.video),
          window.MediaStream) {
              var n = new MediaStream(e.stream.stream.getAudioTracks());
              t.video.srcObject = n
          } else
              t.video.srcObject = e.stream.stream;
          return t
      };
      t.default = l
  }
  ...
  , function(e, t, n) {
      ...
      !function(o, a) {
            ...
            , n = function(i, r) {
              ...
              function s(e, n) {
                  if (e.resizedAttached) {
                      if (e.resizedAttached)
                          return void e.resizedAttached.add(n)
                  } else
                      e.resizedAttached = new o,
                  ...
                  e.resizeSensor.innerHTML = '<div class="resize-sensor-expand" style="' + i + '"><div style="' + r + '"></div></div><div class="resize-sensor-shrink" style="' + i + '"><div style="' + r + ' width: 200%; height: 200%"></div></div>',
                  e.appendChild(e.resizeSensor),
                  "static" == a(e, "position") && (e.style.position = "relative");
                  var s, d, c, u, l = e.resizeSensor.childNodes[0], p = l.childNodes[0], f = e.resizeSensor.childNodes[1], m = e.offsetWidth, g = e.offsetHeight, v = function() {
          ...
          return n.detach = function(t, n) {
              e(t, function(e) {
                  e.resizedAttached && "function" == typeof n && (e.resizedAttached.remove(n),
  ...
  , function(e, t, n) {
      ...
      function(e) {
          ...
          t.peerConnection.onicecandidate = function(e) {
              e.candidate ? t.iceCandidateCount += 1 : (r.default.debug("PeerConnection State: " + t.peerConnection.iceGatheringState),
              void 0 === t.ices && (t.ices = 0),
              t.ices = t.ices + 1,
              t.ices >= 1 && t.moreIceComing && (t.moreIceComing = !1,
              t.markActionNeeded()))
          }
          ;
          var i = function(t) {
          ...
          return t.processSignalingMessage = function(e) {
              ...
              t.peerConnection.setRemoteDescription(new RTCSessionDescription(n)),
              t.state = "offer-received",
              t.markActionNeeded()) : t.error("Illegal message for this state: " + r.messageType + " in state " + t.state))
          }
          ,
              ...
              if (t.actionNeeded) {
                  if ("new" === t.state || "established" === t.state)
                      ...
                      t.peerConnection.createAnswer(function(e) {
                          ...
                          var n = new Date;
                          r.default.debug(n.getTime() + ": Starting ICE in responder"),
                          t.iceStarted = !0
                      }, function(e) {
      ...
      var i = n(0)
        ...
        , a = function(e) {
          ...
          t.peerConnection.onicecandidate = function(e) {
              ...
              null === i && null === o && null === a || void 0 !== t.ice || (r.default.debug("srflx candidate : " + i + " relay candidate: " + a + " host candidate : " + o),
          ...
          t.getStats = function(e) {
              t.peerConnection.getStats(null, function(n) {
                  ...
                  Object.keys(n).forEach(function(e) {
                      var t = n[e];
                      r.push(t),
                      "ssrc" !== t.type && "VideoBwe" !== t.type || (o = t.timestamp,
                      i.push(t))
                  }),
                  i.push({
                      id: "time",
      ...
      var i = n(0)
        ...
        , a = function(e) {
          ...
          t.processSignalingMessage = function(e) {
              ...
              t.state = "offer-received",
              t.markActionNeeded()) : t.error("Illegal message for this state: " + o.messageType + " in state " + t.state) : "offer-sent" === t.state ? "ANSWER" === o.messageType ? (r = {
                  sdp: o.sdp,
                  type: "answer"
              },
              r.sdp = n(r.sdp),
              ...
              t.peerConnection.setRemoteDescription(new RTCSessionDescription(r)),
              t.sendOK(),
              t.state = "established") : "pr-answer" === o.messageType ? (r = {
                  sdp: o.sdp,
                  type: "pr-answer"
              },
              ...
              t.peerConnection.setRemoteDescription(new RTCSessionDescription(r)),
              t.state = "offer-received",
              t.markActionNeeded()) : t.error("Illegal message for this state: " + o.messageType + " in state " + t.state))
          }
          ;
          var a = {
              id: "",
          ...
          return t.getStatsRate = function(e) {
              t.getStats(function(t) {
                  t.forEach(function(e) {
                      "outbound-rtp" === e.type && "video" === e.mediaType && e.googFramesEncoded && (e.googFrameRateSent = ((e.googFramesEncoded - l) / 3).toString(),
                      l = e.googFramesEncoded),
                      "inbound-rtp" === e.type && -1 != e.id.indexOf("55543") && (e.googFrameRateReceived && (e.googFrameRateReceived = ((e.googFrameReceived - f) / 3).toString(),
                      f = e.googFrameReceived),
          ...
          t.getStats = function(e) {
              ...
              t.peerConnection.getStats().then(function(i) {
                  i.forEach(function(e) {
                      ...
                      "inbound-rtp" === e.type && -1 != e.id.indexOf("55543") && (c.id = e.id,
                      c.type = e.type,
                      c.mediaType = "video",
                      ...
                      "track" === e.type && -1 != e.id.indexOf("55543") && (c.googFrameWidthReceived = e.frameWidth ? e.frameWidth + "" : "0",
                      ...
                      "track" === e.type && -1 != e.id.indexOf("44444") && (d.audioOutputLevel = e.audioLevel + "",
                      a.audioInputLevel = e.audioLevel + ""),
              ...
              if (t.actionNeeded) {
                  if ("new" === t.state || "established" === t.state) {
                      ...
                      t.peerConnection.createOffer(t.mediaConstraints).then(function(n) {
                          if (n.sdp = i(n.sdp),
                          e.isSubscriber || (n.sdp = n.sdp.replace(/a=extmap:4 urn:3gpp:video-orientation\r\n/g, "")),
                          n.sdp !== t.prevOffer)
      ...
      var i = n(0)
        ...
        , a = function(e) {
          ...
          t.processSignalingMessage = function(e) {
              ...
              t.incomingMessage = o,
              "new" === t.state ? "OFFER" === o.messageType ? (o.sdp = l(o.sdp),
              i = {
                  sdp: o.sdp,
                  type: "offer"
              },
              ...
              t.state = "offer-received",
              t.markActionNeeded()) : t.error("Illegal message for this state: " + o.messageType + " in state " + t.state) : "offer-sent" === t.state ? "ANSWER" === o.messageType ? (o.sdp = l(o.sdp),
          ...
          t.getStatsRate = function(e) {
              t.getStats(function(t) {
                  t.forEach(function(e) {
                      "inboundrtp" === e.type && "video" === e.mediaType && e.googFrameRateDecoded && (e.googFrameRateDecoded = ((e.googFramesDecoded - u) / 3).toString(),
          ...
          t.getStats = function(e) {
              t.peerConnection.getStats().then(function(n) {
                  ...
                  Object.keys(n).forEach(function(e) {
                      var t = n[e];
                      i.push(t),
                      "outboundrtp" === t.type && "video" === t.mediaType && (s.id = t.id,
                      s.type = t.type,
                      ...
                      "inboundrtp" !== t.type || "video" !== t.mediaType || t.isRemote || (c.id = t.id,
                      c.type = t.type,
  ...
  , function(e, t, n) {
      ...
      var i = function(e) {
          ...
          return e.forEach(function(e) {
              "VideoBwe" === e.type ? t.videoSendBandwidth = e.googAvailableSendBandwidth : -1 !== e.id.indexOf("send") || -1 !== e.id.indexOf("outbound_rtp") || -1 !== e.id.indexOf("OutboundRTP") ? "audio" === e.mediaType ? (t.audioSendBytes = e.bytesSent,
              t.audioSendPackets = e.packetsSent,
              t.audioCodecName = e.googCodecName) : (t.videoSendBytes = e.bytesSent,
              ...
              t.videoCodecName = e.googCodecName) : "time" === e.id && (t.timestamp = e.timestamp,
        ...
        , r = function(e) {
          ...
          return e.forEach(function(e) {
              "VideoBwe" === e.type ? t.videoReceiveBandwidth = e.googAvailableReceiveBandwidth : -1 !== e.id.indexOf("recv") || -1 !== e.id.indexOf("inbound_rtp") || -1 !== e.id.indexOf("InboundRTP") ? "audio" === e.mediaType ? (t.audioReceiveBytes = e.bytesReceived,
              t.audioReceivePackets = e.packetsReceived,
              t.audioReceivePacketsLost = e.packetsLost) : (t.videoReceiveBytes = e.bytesReceived,
              ...
              t.videoReceivedResolutionHeight = e.googFrameHeightReceived) : "time" === e.id && (t.timestamp = e.timestamp,
              t.startTime = e.startTime)
          }),
          t.timestamp instanceof Date && t.startTime instanceof Date && (t.duration = Math.floor((t.timestamp.getTime() - t.startTime.getTime()) / 1e3) + ""),
          t
      };
      t.publishStatsFilter = i,
      t.subscribeStatsFilter = r
  }
  , function(e, t, n) {
      "use strict";
      function i(e) {
      ...
      var r = n(31)
        ...
        , E = function(e) {
          ...
          t.setTurnServer = function(e, n, i) {
              var r = e.turnServerURL
                ...
                , u = e.tcpport;
              if (!r)
                  throw new Error("Do not set the turnServerURL parameter as empty");
              if (!o)
                  throw new Error("Do not set the username parameter as empty");
              if (!a)
                  throw new Error("Do not set the password parameter as empty");
              if (!d)
                  throw new Error("Do not set the udpport parameter as empty");
              t.turnServer.url = r,
              t.turnServer.udpport = d,
              t.turnServer.username = o,
              t.turnServer.credential = a,
              t.turnServer.forceturn = c || !1,
              u && (t.turnServer.tcpport = u,
              s.default.info("Set turnserver tcpurl." + t.turnServer.url + ":" + t.turnServer.tcpport)),
          ...
          t.setEncryptionMode = function(e) {
              if ("string" != typeof e)
                  throw new Error("Invalid encryptionMode");
              S.ENCRYPTION_MODES.includes(e) || (e = S.ENCRYPTION_MODE_NONE),
              t.aesmode = e
          }
          ,
          ...
          t.enableDualStream = function(n, i) {
              return "iOS" === (0,
              f.getBrowserOS)() ? (p.report.streamSwitch(e.sessionId, {
                  lts: (new Date).getTime(),
                  isdual: !0,
                  succ: !1
              }),
              i && i(c.default.IOS_NOT_SUPPORT)) : (0,
              f.isWeChatBrowser)() ? (p.report.streamSwitch(e.sessionId, {
                  lts: (new Date).getTime(),
                  isdual: !0,
                  succ: !1
              }),
              ...
              t.isDualStream = !0,
              void (0 === t.highStreamState ? t._publishLowStream(n, function(e) {
                  s.default.warning(e),
                  i && i(c.default.ENABLE_DUALSTREAM_FAILED)
          ...
          t.disableDualStream = function(n, i) {
              ...
              t.isDualStream = !1,
              0 === t.highStreamState ? t._unpublishLowStream(n, function(e) {
                  s.default.warning(e),
                  i && i(c.default.DISABLE_DUALSTREAM_FAILED)
              }) : 1 === t.highStreamState ? i && i(c.default.STILL_ON_PUBLISHING) : n && n()
          }
          ,
          t._createLowStream = function(e, n) {
              if (!t.highStream || !t.highStream.stream)
                  return void (n && n(c.default.HIGH_STREAM_NOT_VIDEO_TRACE));
              ...
              t._getVideoCameraIdByLabel(r.label, function(o) {
                  ...
                  if (a.streamId = t.highStream.getId() + 1,
                  t.lowStreamParameter) {
                      var d = Object.assign({}, t.lowStreamParameter);
                      if (!d.width || !d.height) {
                          var c = (0,
                          m.simMap)(t.highStream.profile)
                            , u = _.SUPPORT_RESOLUTION_LIST[c[0]];
                          d.width = u[0],
                          d.height = u[1]
                      }
                      if (d.framerate = d.framerate || 5,
                      d.bitrate = d.bitrate || 50,
                      (0,
                      f.isSafari)() || (0,
                      f.isOpera)()) {
          ...
          t._publishLowStream = function(e, n) {
              return 2 !== t.lowStreamState ? n && n(c.default.LOW_STREAM_ALREADY_PUBLISHED) : t.highStream && t.highStream.hasScreen() ? n && n(c.default.SHARING_SCREEN_NOT_SUPPORT) : void t._getLowStream(function(i) {
                  ...
                  t.gatewayClient.publish(i, function() {
                      ...
                      s.default.debug("publish low stream failed"),
                      n && n(e)
                  })
              }, n)
          }
          ...
          t._unpublishLowStream = function(e, n) {
              if (0 !== t.lowStreamState)
                  return n && n(c.default.LOW_STREAM_NOT_YET_PUBLISHED);
              t.lowStream && (t.gatewayClient.unpublish(t.lowStream, function() {}, function(e) {
                  s.default.debug("unpublish low stream failed"),
                  n && n(e)
              }),
              t.lowStream.close(),
              t.lowStream = null,
          ...
          t.join = function(n, i, r, o, a) {
              if (n && "string" != typeof n)
                  return s.default.warning("Param channelKey should be string"),
                  a && a(c.default.INVALID_PARAMETER);
              if ("string" != typeof i)
                  return s.default.warning("Param channel should be string"),
                  a && a(c.default.INVALID_PARAMETER);
              if (r && ("number" != typeof r || !(0,
              u.is32Uint)(r)))
                  return s.default.warning("Param uid should be number"),
                  a && a(c.default.INVALID_PARAMETER);
              t.highStream = null,
              t.lowStream = null,
              t.lowStreamParameter = null,
              ...
              l.getGatewayList)(d, function(r) {
                  ...
                  t.joinInfo = d,
                  t.gatewayClient.join(d, t.key, function(e) {
                      s.default.info("Join channal " + i + " success"),
                      o && o(e)
                  }, a)
              }, a)
          }
          ...
          t.renewChannelKey = function(e, n, i) {
              void 0 === t.key ? (s.default.error("renewChannelKey should not be called before user join"),
              (0,
              u.safeCall)(i, c.default.INVALID_OPERATION)) : (t.key = e,
          ...
          t.leave = function(e, n) {
              s.default.info("Leaving channel"),
              t.gatewayClient.leave(e, n)
          }
          ,
          t._publish = function(n, i, r) {
              if (2 !== t.highStreamState)
                  return s.default.warning("Can't publish stream when stream already publish", n.getId()),
                  r && r(c.default.STREAM_ALREADY_PUBLISHED);
              s.default.info("Publishing stream, uid: ", n.getId()),
              t.highStream = n,
              t.highStreamState = 1,
              t.highStream.streamId = t.joinInfo.uid,
              t.gatewayClient.publish(n, function() {
                  n.sid = e.sessionId,
                  t.highStreamState = 0,
          ...
          t._unpublish = function(e, n, i) {
              if (0 !== t.highStreamState)
                  return s.default.warning("Can't unpublish stream when stream not publish"),
                  i && i(c.default.STREAM_NOT_YET_PUBLISHED);
              s.default.info("Unpublish stream, uid: ", e.getId()),
              t.isDualStream && t.lowStream ? (t._unpublishLowStream(null, i),
              t.gatewayClient.unpublish(e, null, i),
              t.highStreamState = 2,
              s.default.info("Unpublish stream success, uid:", e.getId())) : (t.gatewayClient.unpublish(e, null, i),
              t.highStreamState = 2,
          ...
          t.setLiveTranscoding = function(e) {
              Object.assign(I, e),
              t.gatewayClient.setLiveTranscoding(I)
          }
          ,
          t.gatewayClient = (0,
          o.default)(e),
          ...
          t.on("onMultiIP", function(e) {
              ...
              (0,
              l.getGatewayList)(t.joinInfo, function(e) {
                  ...
                  t.gatewayClient.join(t.joinInfo, t.key, function(e) {
                      s.default.info("Join channal " + t.channel + " success"),
          ...
          t.on("rejoin", function() {
              ...
              t.highStream && 0 === e && (s.default.info("publish after rejoin"),
              t.highStreamState = 2,
              t.lowStreamState = 2,
          ...
          t.on("pubP2PLost", function(e) {
              ...
              t._unpublish(t.highStream, function() {
                  t._publish(t.highStream, function() {
                      s.default.debug("Reconnect local peerConnection success:", t.highStream.getId()),
                      t.gatewayClient.dispatchEvent({
          ...
          t.on("subP2PLost", function(e) {
              ...
              t.gatewayClient.unsubscribe(e.stream, function() {
                  t.gatewayClient.subscribe(e.stream, function() {
                      s.default.debug("Reconnect remote peerConnection success:", e.stream.getId()),
                      t.gatewayClient.dispatchEvent({
                          type: "stream-reconnect-end",
                          id: e.stream.getId()
                      })
                  }, function(n) {
                      s.default.debug("Reconnect remote peerConnection failed:" + n),
                      t.gatewayClient.dispatchEvent({
                          type: "stream-reconnect-end",
                          id: e.stream.getId()
                      })
        ...
        , A = function(e) {
          e = Object.assign({}, e || {}),
          e.codec || (e.codec = R(e.mode));
          var t = b(e);
          if (t)
              throw s.default.error("Invalid parameter setting MODE : " + e.mode + " CODEC : " + e.codec + " ERROR " + t),
              new Error(t);
          return s.default.info("Creating client , MODE : " + e.mode + " CODEC : " + e.codec),
          y(e),
          E(e)
      }
        , C = function() {
          return s.default.info("Creating client , MODE : rtc"),
      ...
      : function(e) {
        ...
        , b = function(e) {
          ...
          M.join = function(e, t, r, o) {
              var a = (new Date).getTime()
                , s = e.uid;
              return 0 !== M.state ? (l.default.error("Server already in connecting/connected state"),
              ...
              void S.report.joinGateway(e.sid, {
                  ...
                  addr: null
              })) : null !== s && void 0 !== s && parseInt(s) !== s ? (l.default.error("Input uid is invalid"),
          ...
          M.leave = function(e, t) {
              ...
              for (var n in M.localStreams)
                  if (M.localStreams.hasOwnProperty(n)) {
                      ...
                      delete M.localStreams[n],
                      void 0 !== i.pc && (i.pc.close(),
                      i.pc = void 0)
                  }
              K(),
              M.state = 0
          ...
          M.publish = function(e, t, n) {
              ...
              "object" !== (void 0 === e ? "undefined" : r(e)) || null === e)
                  return l.default.error("Invalid local stream"),
                  n && n(f.default.INVALID_LOCAL_STREAM),
              ...
              if (null === e.stream && void 0 === e.url)
                  return l.default.error("Invalid local media stream"),
                  n && n(f.default.INVALID_LOCAL_STREAM),
                  void S.report.publish(M.joinInfo.sid, {
                      lts: i,
                      succ: !1,
              ...
              if (2 !== M.state)
                  return l.default.error("User is not in the session"),
                  ...
                  d.Connection)({
                      callback: function(r) {
                          ...
                          z(A({
                              ...
                              if ("error" === o)
                                  return l.default.error("Publish local stream failed"),
                              ...
                              e.pc.onsignalingmessage = function(t) {
                                  ...
                                  ,
                                  e.getId() === e.getUserId() && (e.isAudioOn() || e.hasAudio() && (l.default.debug("local stream audio mute"),
                                  e.muteAudio()),
                                  e.isVideoOn() || (e.hasVideo() || e.hasScreen()) && (l.default.debug("local stream video mute"),
                                  e.muteVideo()))
                              }
                              ,
                              e.pc.oniceconnectionstatechange = function(r) {
                                  "failed" === r ? (void 0 != M.timers[e.getId()] && clearInterval(M.timers[e.getId()]),
                                  ...
                                  })) : "connected" === r && (l.default.debug("publish p2p connected: ", M.p2ps),
                                  t && t(),
                                  S.report.publish(M.joinInfo.sid, {
                                      lts: i,
                                      succ: !0,
                  ...
                  M.timers[e.getId()] = setInterval(function() {
                      e && e.pc && e.pc.getStats && e.pc.getStatsRate(function(t) {
                          t.forEach(function(t) {
                              -1 === t.id.indexOf("outbound_rtp") && -1 === t.id.indexOf("OutboundRTP") || "video" !== t.mediaType || (t.googFrameWidthSent = e.videoWidth + "",
                              t.googFrameHeightSent = e.videoHeight + ""),
                              e.getUserId && (e.getId() == e.getUserId() ? G(C(t), null, null) : G(O(t), null, null))
                          })
                      })
                  }, 3e3),
                  void 0 !== e.aux_stream && (e.pc.addStream(e.aux_stream),
                  l.default.debug("PeerConnection add stream :", e.aux_stream)))
              }
          }
          ,
          M.unpublish = function(e, t, n) {
              return "object" !== (void 0 === e ? "undefined" : r(e)) || null === e ? (l.default.error("Invalid local stream"),
              void P(n, f.default.INVALID_LOCAL_STREAM)) : 2 !== M.state ? (l.default.error("User not in the session"),
              void P(n, f.default.INVALID_OPERATION)) : (void 0 != M.timers[e.getId()] && clearInterval(M.timers[e.getId()]),
              void (void 0 !== M.socket ? e.local && void 0 !== M.localStreams[e.getId()] ? (delete M.localStreams[e.getId()],
              G(I(e.getUserId())),
              ...
              t && t()) : (l.default.error("Invalid local stream"),
              P(n, f.default.INVALID_LOCAL_STREAM)) : (l.default.error("User not in the session"),
              P(n, f.default.INVALID_OPERATION))))
          }
          ,
          M.subscribe = function(e, t, n) {
              ...
              if (e.subscribeLTS = i,
              "object" !== (void 0 === e ? "undefined" : r(e)) || null === e)
                  return l.default.error("Invalid remote stream"),
                  ...
                  if (e.hasAudio() || e.hasVideo() || e.hasScreen()) {
                      ...
                      d.Connection)({
                          callback: function(t) {
                              ...
                              z(T({
                                  ...
                                  if ("error" === t)
                                      return l.default.error("Subscribe remote stream failed, closing stream ", e.getId()),
                                      e.close(),
                                  ...
                                  l.default.debug("SDP exchange in subscribe : receive answer --  ", JSON.parse(t)),
                      ...
                      e.pc.onaddstream = function(t, n) {
                          if ("ontrack" === n && "video" === t.track.kind || "onaddstream" === n) {
                              if (l.default.info("Remote stream subscribed with uid ", e.getId()),
                              M.remoteStreams[e.getId()].stream = "onaddstream" === n ? t.stream : t.streams[0],
                              M.remoteStreams[e.getId()].hasVideo()) {
                                  if ((0,
                                  h.isFireFox)()) {
                                      var i = M.remoteStreams[e.getId()].stream;
                                      (0,
                                      E.vsResHack)(i, function(t, n) {
                                          e.videoWidth = t,
                                          e.videoHeight = n
                                      }, function(e) {
                      ...
                      M.timers[e.getId()] = setInterval(function() {
                          e && e.pc && e.pc.getStats && e.pc.getStatsRate(function(t) {
                              t.forEach(function(t) {
                                  -1 !== t.id.indexOf("inbound_rtp") && "video" === t.mediaType && (t.googFrameWidthReceived = e.videoWidth + "",
                              ...
                              t.forEach(function(t) {
                                  if ("audio" === t.mediaType) {
                                      if (t.audioOutputLevel > 5e3) {
                                          ...
                                          for (var n in M.audioLevel)
                                              parseInt(n) !== e.getId() && M.audioLevel[n] > 0 && (M.audioLevel[n] -= 1)
                                      }
                      ...
                      e.pc.oniceconnectionstatechange = function(r) {
                          ...
                          n && n(f.default.PEERCONNECTION_FAILED),
                          M.remoteStreams[e.getId()] && M.dispatchEvent((0,
                          c.ClientEvent)({
                              type: "subP2PLost",
                              stream: e
                          })),
                          ...
                          M.firstFrameTimer.set(e.getId(), setInterval(function() {
                              e.pc ? e.pc.getStats(function(t) {
                                  t.forEach(function(t) {
                                      -1 === t.id.indexOf("recv") && -1 === t.id.indexOf("inbound_rtp") && -1 === t.id.indexOf("InboundRTP") || "video" === t.mediaType && (t.framesDecoded > 0 || t.googFramesDecoded > 0) && (clearInterval(M.firstFrameTimer.get(e.getId())),
          ...
          M.unsubscribe = function(e, t, n) {
              return "object" !== (void 0 === e ? "undefined" : r(e)) || null === e ? (l.default.error("Invalid remote stream"),
              void P(n, f.default.INVALID_REMOTE_STREAM)) : 2 !== M.state ? (l.default.error("User is not in the session"),
              void P(n, f.default.INVALID_OPERATION)) : (void 0 != M.timers[e.getId()] && (clearInterval(M.timers[e.getId()]),
              clearInterval(M.timers[e.getId()] + "audio")),
              void 0 != M.audioLevel[e.getId()] && delete M.audioLevel[e.getId()],
              void 0 != M.timer_counter[e.getId()] && delete M.timer_counter[e.getId()],
              M.remoteStreams.hasOwnProperty(e.getId()) ? M.socket ? e.local ? (l.default.error("Invalid remote stream"),
              void P(n, f.default.INVALID_REMOTE_STREAM)) : (e.close(),
              void G(b(e.getId()), function(i) {
                  if ("error" === i)
                      return l.default.error("Unsubscribe remote stream failed", e.getId()),
                      void P(n, f.default.UNSUBSCRIBE_STREAM_FAILED);
                  ...
                  t && t()
              }, n)) : (l.default.error("User is not in the session"),
              void P(n, f.default.INVALID_OPERATION)) : void P(n, f.default.NO_SUCH_REMOTE_STREAM))
          }
          ,
          M.setRemoteVideoStreamType = function(e, t) {
              if (l.default.debug("Switching remote video stream " + e.getId() + " to " + t),
              "object" !== (void 0 === e ? "undefined" : r(e)) || null === e)
          ...
          M.stopLiveStreaming = function(e) {
              if (l.default.debug("Stop live streaming " + e),
              2 !== M.state)
                  return void l.default.error("User is not in the session");
              M.liveStreams.delete(e),
              G(D(e), null, null)
          }
          ,
          M.setLiveTranscoding = function(e) {
              if ((0,
              E.isLiveTranscodingValid)(e)) {
                  if (M.transcoding = e,
                  l.default.debug("Set live transcoding ", e),
                  2 !== M.state)
                      return void l.default.error("User is not in the session");
                  G(L(e), null, null)
              }
          ...
          var k = function(e) {
            ...
            , V = function(e, t) {
              l.default.debug("Connect next gateway"),
              M.state = 0,
              M.socket.close(),
              B(),
            ...
            , x = function(e, t) {
              l.default.debug("Reconnect gateway"),
              M.state = 0,
              M.socket.close(),
              B(),
              M.reconnectMode = "retry",
            ...
            , B = function() {
              for (var e in M.timers)
                  M.timers.hasOwnProperty(e) && clearInterval(M.timers[e]);
          ...
          M.rejoin = function() {
              0 !== M.state && (M.state = 0),
              M.socket && (clearInterval(M.pingTimer),
              M.socket.close(),
              M.socket = void 0),
              j()
          }
          ...
          var j = function(e, t) {
              e = e || function(e) {
                  ...
                  M.liveStreams && M.liveStreams.size && M.liveStreams.forEach(function(e, t) {
                      e && M.setLiveTranscoding(M.transcoding),
                      M.startLiveStreaming(t, e)
                  })
              }
              ,
              t = t || function(e) {
              ...
              ,
              M.key ? (++M.rejoinAttempt,
              M.join(M.joinInfo, M.key, e, t)) : l.default.error("Connection recover failed [Invalid channel key]")
          }
            , H = function(e) {
              M.socket = (0,
              s.default)(e, {
            ...
            , W = function(e, n, i) {
              M.onConnect = n,
              void 0 !== M.socket ? "retry" === M.reconnectMode ? (l.default.debug("Retry current gateway"),
              M.socket.reconnect()) : "tryNext" === M.reconnectMode ? (l.default.debug("Try next gateway"),
              M.socket.connectNext()) : "recover" === M.reconnectMode && (l.default.debug("Recover gateway"),
              l.default.debug("Try to reconnect choose server and get gateway list again "),
              (0,
              v.getGatewayList)(M.joinInfo, function(e) {
              ...
              M.socket.on("disconnect", function(e) {
                  if (0 !== M.state) {
                      ...
                      if (M.dispatchEvent(n),
                      0 === M.p2ps.size ? M.reconnectMode = "tryNext" : M.reconnectMode = "retry",
                      B(),
                      1 != t) {
                          var i = k(M.attemps);
              ...
              M.socket.on("onAddAudioStream", function(e) {
                  if (l.default.info("Newly added audio stream with uid", e.id),
              ...
              M.socket.on("onAddVideoStream", function(e) {
                  if (l.default.info("Newly added remote stream with uid", e.id),
                  M.remoteStreamsInChannel.has(e.id) || M.remoteStreamsInChannel.add(e.id),
                  void 0 === M.remoteStreams[e.id]) {
                      var t = (0,
                      o.Stream)({
              ...
              M.socket.on("onRemoveStream", function(e) {
                  ...
                  if (!t)
                      return void console.log("ERROR stream ", e.id, " not found onRemoveStream ", e);
              ...
              M.socket.on("onP2PLost", function(e) {
                  if (l.default.debug("p2plost:", e, "p2ps:", M.p2ps),
                  "publish" === e.event) {
                  ...
                  i && (M.p2ps.delete(e.p2pid),
                  i.local ? M.dispatchEvent((0,
                  c.ClientEvent)({
                      type: "pubP2PLost",
                      stream: i
                  })) : M.remoteStreams[i.getId()] && M.dispatchEvent((0,
                  c.ClientEvent)({
                      type: "subP2PLost",
                      stream: i
                  })))
              ...
              M.socket.on("notification", function(e) {
                  if (l.default.debug("Receive notification: ", e),
                  "ERR_JOIN_BY_MULTI_IP" === p.GatewayErrorCode[e.code])
              ...
              M.socket.on("onPeerLeave", function(e) {
                  ...
                  if (M.remoteStreamsInChannel.has(e.id) && M.remoteStreamsInChannel.delete(e.id),
                  ...
                  M.remoteStreams.hasOwnProperty(e.id)) {
                      ...
                      n.pc = void 0,
                      M.p2ps.delete(n.p2pId))
                  }
                  M.timers.hasOwnProperty(e.id) && (clearInterval(M.timers[e.id]),
                  delete M.timers[e.id]),
            ...
            , G = function(e, t, n) {
              if (void 0 === M.socket)
                  return l.default.error("No socket available"),
                  void P(n, f.default.INVALID_OPERATION);
              try {
      ...
      var r = n(3)
        ...
        , u = function(e) {
          ...
          t.connectNext = function() {
              ...
              t.hostIndex >= t.host.length ? t.dispatchEvent((0,
              r.MediaEvent)({
                  type: "recover"
              })) : t.creatConnection()
          }
          ...
          t.creatConnection = function() {
              ...
              t.connection.onmessage = function(e) {
                  ...
                  n.hasOwnProperty("_id") ? t.dispatchEvent((0,
                  r.MediaEvent)({
                      type: n._id,
                      msg: n
                  })) : n.hasOwnProperty("_type") && t.dispatchSocketEvent((0,
                  r.MediaEvent)({
                      type: n._type,
                      msg: n.message
                  }))
              ...
              t.connection.onclose = function(n) {
                  t.needReconnect ? t.isTimeout || t.isInit ? (d.default.debug("websockect connect timeout"),
                  ...
                  t.connectNext()) : t.dispatchEvent((0,
                  r.MediaEvent)({
                      type: "disconnect",
                      event: n
                  })) : (d.default.debug("websockect closeed"),
                  (0,
                  a.default)(e.onFailure, n),
                  clearTimeout(t.timeoutCheck),
                  t.dispatchEvent((0,
                  r.MediaEvent)({
                      type: "close",
  ...
  , function(e, t, n) {
      ...
      var i = n(2)
        , r = function(e) {
          ...
          return (0,
          i.isOpera)() ? [e, 15, 50] : (0,
          i.isFireFox)() ? [t[1], 15, 100] : (0,
          i.isSafari)() ? [t[2], 15, 50] : [t[0], 15, 50]
      };
      t.simMap = r
  }
  ]).default
